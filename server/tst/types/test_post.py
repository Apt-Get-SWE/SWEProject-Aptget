...
class TestPost:
    ...
    def test_from_json(self):
        ...
        post = Post.from_json('{"pid": "123", "uid": "234", "aid": "345", "title": "Selling chairs!", "descr": "willing to negotiate", "condition": "new", "list_dt": "10/29/2022 10:11:53", "price": "24.99", "sold": "False"}')
        assert post.pid == "123"
        assert post.uid == "234"
        assert post.aid == "345"
    ...
    def test_to_json_str(self):
        # Test with a valid post
        post = Post('123', '234', '345', 'Selling chairs!', 'willing to negotiate', 'new', '10/29/2022 10:11:53', "24.99", "False")
