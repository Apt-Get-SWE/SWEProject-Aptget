...
class TestAddress:
    def test_from_json(self):
        ...
        addr = Address.from_json('{"aid": "123", "building": "370 Jay St", "city": "Brooklyn", "state": "NY", "zipcode": "11201"}')
        assert addr.aid      == "123"
    ...
    def test_to_json_str(self):
        ...
        assert data == '{"aid": "123", "building": "370 Jay St", "city": "Brooklyn", "state": "NY", "zipcode": "11201"}'

    def test_query(self):
        return # CI/CD test don't work w/ localdb

        Address.insert({"aid": "123", "building": "370 Jay St", "city": "Brooklyn", "state": "NY", "zipcode": "11201"})
